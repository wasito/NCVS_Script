...
nomorItem = 0;item[nomorItem] = 'a. Sekoci dan rakit penolong (lifeboat & Life Raft).';a1[0] = 85;a2[0] = 'Panjang lebih besar atau sama dengan 85 meter';a3[0] = [];a3[0][0] = '1 (satu) buah sekoci kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 2.2 dengan kapasitas 100% total jumlah pelayar pada setiap sisi kapal. Salah satunya dilengkapi motor. atau 1 (satu) buah sekoci luncur/jatuh bebas (free fall lifeboat) dengan kapasitas 100% total jumlah pelayar.';
a3[0][1] = 'Rakit penolong kembung (Inflatable Life Raft) kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.2 dan 7.1 dengan kapasitas 100% total jumlah pelayar yang dapat dipindah-pindahkan dari satu sisi kesisi lainnya; atau Rakit penolong kembung (Inflatable Life Raft) kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.2 dan 7.1 dengan kapasitas 100% total jumlah pelayar pada setiap sisi kapal.';
a1[1] = 35;a2[1] = 'Panjang 35 meter atau lebih tetapi kurang dari 85 meter';a3[1] = [];a3[1][0] = '1 (satu) buah sekoci kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 2.2dengan kapasitas 100% total jumlah pelayar pada setiap sisi kapal. Salah satunya dilengkapi motor.';
a3[1][1] = 'Rakit penolong kembung (Inflatable Life Raft) kategori C yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.3 dan 7.1 dengan kapasitas 100% total jumlah pelayar yang dapat dipindah-pindahkan dari satu sisi kesisi lainnya; atau Rakit penolong kembung (Inflatable Life Raft) kategori C yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.3 dan 7.1 dengan kapasitas 100% total jumlah pelayar pada setiap sisi kapal.';
a1[2] = 20;a2[2] = 'Panjang 20 sampai dengan kurang dari 35';a3[2] = [];a3[2][0] = 'Rakit penolong kembung (Inflatable Life Raft) kategori C yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.3 dan 7.1 dengan kapasitas 100% total jumlah pelayar yang dapat dipindah-pindahkan dari satu sisi kesisi lainnya; atau Rakit penolong kembung (Inflatable Life Raft) kategori C yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.3 dan 7.1 dengan kapasitas 100% total jumlah pelayar pada setiap sisi kapal.';
...
nomorItem = 1;item[nomorItem] = 'b. Sekoci penyelamat (rescue boat)';a1[0] = 500;a2[0] = 'GT lebih besar sama dengan 500';a3[0] = [];a3[0][0] = 'Belum diatur di dalam NCVS';
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Dilengkapi dengan 1 (satu) unit sekoci penyelamat kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 4 klausul 4.2.';
...
nomorItem = 3;item[nomorItem] = 'd. Baju penolong';a1[0] = 0;a2[0] = 'Semua Ukuran';a3[0] = [];a3[0][0] = 'Baju penolong kategori A yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 10 klausul 10.1 yang dilengkapi lampu, peluit dan pita pemantul cahaya (retro-reflektor tape) sejumlah 100% total jumlah pelayar.';
...
a1[2] = 175;a2[2] = 'GT 175 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = 'Sarana pelontar tali yang memenuhi persyaratan Standar Kapal Non Konvensi Bab IV Seksi 16. dengan 2 unit proyektil dan tali;';
a1[3] = 0;a2[3] = 'GT kurang dari 175';a3[3] = [];a3[3][0] = 'Tali buangan dengan panjang 30 m sejumlah 4 unit.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = '12 buah roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi13;';
...
a3[1][2] = '2 buah tabung asap oranye yang memenuhi persyaratan Standar Kapal Non Konvensi Bab IV Seksi 15; ';
...
a1[3] = 0;a2[3] = 'GT kurang dari 35';a3[3] = [];a3[3][0] = '6 buah roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 6;item[nomorItem] = 'g. Search and rescue radar transponder (SART)';a1[0] = 500;a2[0] = 'GT lebih besar sama dengan 500';a3[0] = [];a3[0][0] = 'Belum diatur di dalam NCVS';
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Dilengkapi dengan 2 unit radar transponder yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 4 klausul 4.2.1.5.';
a1[2] = 0;a2[2] = 'GT kurang dari 300';a3[2] = [];a3[2][0] = 'Dilengkapi dengan 1 unit radar transponder yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 4 klausul 4.2.1.5';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 7;item[nomorItem] = 'h. Two way radio telephony';a1[0] = 500;a2[0] = 'GT lebih besar sama dengan 500';a3[0] = [];a3[0][0] = 'Belum diatur di dalam NCVS';
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Dilengkapi dengan 3 (tiga) unit two way radio telephony yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 4 klausul 4.2.1.6';
a1[2] = 0;a2[2] = 'GT kurang dari 300';a3[2] = [];a3[2][0] = 'Dilengkapi dengan 2 (dua) unit two way radio telephony yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 4 klausul 4.2.1.6.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Lsa2A</i></div>"+teks;
