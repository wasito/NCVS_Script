...
nomorItem = 0;item[nomorItem] = 'a. Sekoci dan rakit penolong (lifeboat & Life Raft).';a1[0] = 85;a2[0] = 'Panjang lebih besar atau sama dengan 85 meter';a3[0] = [];a3[0][0] = '1 (satu) buah sekoci kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 2.2 dengan kapasitas 100% total jumlah pelayar pada setiap sisi kapal. Salah satunya dilengkapi motor.';
a3[0][1] = 'Rakit penolong kembung (Inflatable Life Raft) kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.2 dan 7.1 dengan kapasitas 100% total jumlah pelayar yang dapat dipindah-pindahkan dari satu sisi kesisi lainnya;';
...
a3[1][1] = 'Rakit penolong kembung (Inflatable Life Raft) kategori C yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 6 klausul 6.3 dan 7.1 dengan kapasitas 100% total jumlah pelayar yang dapat dipindah-pindahkan dari satu sisi kesisi lainnya;';
...
nomorItem = 3;item[nomorItem] = 'd. Baju penolong';a1[0] = 0;a2[0] = 'Semua Ukuran';a3[0] = [];a3[0][0] = 'Baju penolong kategori B yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 10 klausul 10.2 yang dilengkapi lampu, peluit dan pita pemantul cahaya (retro-reflektor tape) sejumlah 100% total jumlah pelayar.';
...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = '8 (delapan) unit roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13;';
...
a1[2] = 175;a2[2] = 'GT 175 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = '4 (empat) unit roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13;';
a3[2][1] = '4 (empat) unit cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 14; dan';
a3[2][2] = '2 (dua) unit tabung asap oranye yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 15;';
a1[3] = 0;a2[3] = 'GT kurang dari 175';a3[3] = [];a3[3][0] = '4 buah roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Bab IV Seksi 13.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Dilengkapi dengan 2 (dua) unit two way radio telephony yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 4 klausul 4.2.1.6';
a1[2] = 0;a2[2] = 'GT kurang dari 300';a3[2] = [];a3[2][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Lsa2B</i></div>"+teks;
