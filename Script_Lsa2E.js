...
a1[3] = 10;a2[3] = 'Panjang 10 sampai dengan kurang dari 20 meter';a3[3] = [];a3[3][0] = 'Alat apung sederhana yang dapat menampung 100% total jumlah pelayar.';
...
a3[1][1]=[];a3[1][1][0] = 'Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 9 klausul 9.1.';
...
a3[2][1]=[];a3[2][1][0] = 'Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 9 klausul 9.1.';
...
a3[3][1]=[];a3[3][1][0] = 'Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 9 klausul 9.1.';
...
a3[4][1]=[];a3[4][1][0] = 'Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 9 klausul 9.1.';
...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Tali buangan dengan panjang 30 meter sejumlah 4 unit.';
a1[2] = 35;a2[2] = 'GT 35 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = 'Tali buangan dengan panjang 30 meter sejumlah 2 unit.';
a1[3] = 0;a2[3] = 'GT kurang dari 35';a3[3] = [];a3[3][0] = 'Tali buangan dengan panjang 20 meter sejumlah 1 unit.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = '2 buah roket parasut yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13; dan 2 buah cerawat tangan merah yang memenuhi persyaratan persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14';
a1[2] = 35;a2[2] = 'GT 35 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = '4 buah cerawat tangan merah yang memenuhi persyaratan persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14; dan';
a1[3] = 0;a2[3] = 'GT kurang dari 35';a3[3] = [];a3[3][0] = '2 buah cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 7;item[nomorItem] = 'h. Two way radio telephony';a1[0] = 0;a2[0] = 'Semua Ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Lsa2E</i></div>"+teks;
