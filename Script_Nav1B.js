...
a1[1] = 7;a2[1] = 'GT 7 sampai dengan kurang dari 35';a3[1] = [];a3[1][0] = 'Wajib dilengkapi dengan 1 (satu) unit yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 5 klausul. 5.7';
...
nomorItem = 5;item[nomorItem] = 'f. Alat pancar petunjuk haluan (Transmitting Heading Device)';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
...
a1[1] = 0;a2[1] = 'GT kurang dari 10.000';a3[1] = [];a3[1][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 12;item[nomorItem] = 'm. Alat bantu garis haluan otomatis (Automatic tracking aid)';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 500';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
a1[1] = 0;a2[1] = 'GT kurang dari 500';a3[1] = [];a3[1][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 13;item[nomorItem] = 'n. Alat bantu ploting elektronik (ARPA)';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi radar 9 GHz yang minimal memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 5 klausul 5.9.1';
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 14;item[nomorItem] = 'o. Sistem identifikasi otomatis (AIS)';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi 1 (satu) unit yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 5 klausul 5.11.';
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 16;item[nomorItem] = 'q. Alat ukur kecepatan';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 7;a2[1] = 'GT 7 sampai dengan kurang dari 300';a3[1] = [];a3[1][0] = 'Wajib dilengkapi radio portabel';
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 24;item[nomorItem] = 'y. IAMSAR';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Navigasi1B</i></div>"+teks;
