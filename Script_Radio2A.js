		...
		ArRad = document.forms["myForm"]["areaRadio"].value;
                ...
                var a1 = [1, 2, 3];
                var a2 = ["Area A1", "Area A1+A2", "Area A1+A2+A3"];
                var a3 = [["Wajib dilengkapi dengan 1 (satu) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.1"], ["Wajib dilengkapi dengan 1 (satu) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul. 4.2.1.1"], ["Wajib dilengkapi dengan 2 (dua) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul Bab III. 4.2.1.1"]];
                var i = -1;
                do {
                    i++;
                }
...
a1[1] = 2;a2[1] = 'Area A1+A2';a3[1] = [];a3[1][0] = 'Wajib dilengkapi dengan 1 (satu) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul. 4.2.1.1';
a1[2] = 3;a2[2] = 'Area A1+A2+A3';a3[2] = [];a3[2][0] = 'Wajib dilengkapi dengan 2 (dua) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul Bab III. 4.2.1.1';i = -1; do { i++;} while (ArRad> a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 1;item[nomorItem] = 'b. MF DSC';a1[0] = 1;a2[0] = 'Area A1';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';
a1[1] = 2;a2[1] = 'Area A1+A2';a3[1] = [];a3[1][0] = 'Wajib dilengkapi dengan 1 (satu) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.2';
a1[2] = 3;a2[2] = 'Area A1+A2+A3';a3[2] = [];a3[2][0] = 'Wajib dilengkapi dengan 1 (satu) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.2';i = -1; do { i++;} while (ArRad> a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 2;item[nomorItem] = 'c. HF DSC';a1[0] = 1;a2[0] = 'Area A1';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';
a1[1] = 2;a2[1] = 'Area A1+A2';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';
a1[2] = 3;a2[2] = 'Area A1+A2+A3';a3[2] = [];a3[2][0] = 'Wajib dilengkapi dengan 1 (satu) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.2';i = -1; do { i++;} while (ArRad> a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 3;item[nomorItem] = 'd. NARROW BAND DIRECT PRINTING (NBDP)';a1[0] = 1;a2[0] = 'Area A1';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';
a1[1] = 2;a2[1] = 'Area A1+A2';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';
a1[2] = 3;a2[2] = 'Area A1+A2+A3';a3[2] = [];a3[2][0] = 'Wajib dilengkapi dengan 1 (satu) unit perangkat yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.2';i = -1; do { i++;} while (ArRad> a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
nomorItem = 4;item[nomorItem] = 'e. INMARSAT';a1[0] = 1;a2[0] = 'Area A1';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';
a1[1] = 2;a2[1] = 'Area A1+A2';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';
a1[2] = 3;a2[2] = 'Area A1+A2+A3';a3[2] = [];a3[2][0] = 'Wajib dilengkapi dengan 1 (satu) unit perangkat yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.7';i = -1; do { i++;} while (ArRad> a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[3] = 0;a2[3] = 'GT kurang dari 35';a3[3] = [];a3[3][0] = 'Wajib dilengkapi dengan 1 (satu) unit yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.3';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Radio2A</i></div>"+teks;
