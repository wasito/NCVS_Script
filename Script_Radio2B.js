...
a1[2] = 3;a2[2] = 'Area A1+A2+A3';a3[2] = [];a3[2][0] = 'Wajib dilengkapi dengan 2 (dua) unit perangkat radio yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.1';i = -1; do { i++;} while (ArRad> a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[3] = 0;a2[3] = 'GT kurang dari 35';a3[3] = [];a3[3][0] = 'Wajib dilengkapi dengan 1 (satu) unit yang memenuhi persyaratan Standar Kapal Non Konvensi Bab III Seksi 4 klausul 4.2.1.3';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Radio2B</i></div>"+teks;
