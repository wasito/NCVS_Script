...
nomorItem = 1;item[nomorItem] = 'b. Pedoman gasing';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 2;item[nomorItem] = 'c. Sistem kendali haluan atau lintasan (Heading or track control system (auto pilot))';a1[0] = 10000;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 10;item[nomorItem] = 'k. Radar 3 GHz (Kedua)';a1[0] = 3000;a2[0] = 'GT lebih besar dan sama dengan 3.000';a3[0] = [];a3[0][0] = 'Wajib dilengkapi radar kedua 3 GHz yang minimal memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 5 klausul 5.9.1';
...
nomorItem = 13;item[nomorItem] = 'n. Alat bantu ploting elektronik';a1[0] = 500;a2[0] = 'GT lebih besar dan sama dengan 500';a3[0] = [];a3[0][0] = 'Wajib dilengkapi ';
a1[1] = 0;a2[1] = 'GT kurang dari 500';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 21;item[nomorItem] = 'v. Lampu isyarat (Day light signal)';a1[0] = 300;a2[0] = 'GT lebih besar dan sama dengan 300';a3[0] = [];a3[0][0] = 'Wajib dilengkapi lampu isyarat yang terpisah dari lampu pencarian (search light).';
a1[1] = 0;a2[1] = 'GT kurang dari 300';a3[1] = [];a3[1][0] = 'Wajib dilengkapi minimal dengan lampu senter';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Navigasi2C</i></div>"+teks;
