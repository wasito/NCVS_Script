		...
		ArRad = document.forms["myForm"]["areaRadio"].value;
                ...
                var a2 = ["GT 500 atau lebih", "GT 300 sampai dengan kurang dari 500", "GT 35 sampai dengan kurang dari 300", "GT 7 sampai dengan kurang dari 35", "GT kurang dari 7"];
                var a3 = [["Dilengkapi rakit penolong kembung (Inflatable Life Raft) kategori D yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi. 6 klausul 6.4 dan 7.1 dengan kapasitas 100% total jumlah pelayar.", "Dilengkapi dengan 1 (satu) unit sampan bermotor"], ["Dilengkapi rakit penolong tegar (Rigid Life Raft) yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi. 6 klausul 6.5 atau alat apung yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 8 dengan kapasitas tidak kurang dari 100% total jumlah pelayar.", "Dilengkapi dengan 1 (satu) unit sampan bermotor"], ["Dilengkapi rakit penolong tegar (Rigid Life Raft) yang memenuhi persyaratan Standar Kapal Non Konvensi Bab IV Seksi 6 klausul 6.5 atau alat apung yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 8 dengan kapasitas tidak kurang dari 100% total jumlah pelayar.", "Dilengkapi dengan 1 (satu) unit sampan bermotor"], ["Dilengkapi rakit penolong tegar (Rigid Life Raft) yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi. 6 klausul 6.5 atau alat apung yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 8 dengan kapasitas tidak kurang dari 100% total jumlah pelayar."], ["Alat apung sederhana yang dapat menampung 100% total jumlah pelayar."]];
                var i = -1;
                do {
                    i++;
                }
...
nomorItem = 3;item[nomorItem] = 'd. Baju penolong';a1[0] = 0;a2[0] = 'Semua Ukuran';a3[0] = [];a3[0][0] = 'Baju penolong kategori C yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 10 klausul 10.3 yang dilengkapi lampu, peluit dan pita pemantul cahaya (retro-reflektor tape)';
...
nomorItem = 4;item[nomorItem] = 'e. Alat pelontar tali (line throwing apparatus)';a1[0] = 500;a2[0] = 'GT lebih besar atau sama dengan 500';a3[0] = [];a3[0][0] = 'Dilengkapi dengan tali buangan dengan panjang 30 meter sebanyak 4 unit.';
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Dilengkapi dengan tali buangan dengan panjang 30 meter sebanyak 3 unit.';
a1[2] = 35;a2[2] = 'GT 35 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = 'Dilengkapi dengan tali buangan dengan panjang 30 meter sebanyak 2 unit.';
a1[3] = 0;a2[3] = 'GT kurang dari 35';a3[3] = [];a3[3][0] = 'Dilengkapi dengan tali buangan dengan panjang 20 meter sebanyak 1 unit.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 5;item[nomorItem] = 'f. Isyarat marabahaya (pyrotechnic)';a1[0] = 300;a2[0] = 'GT lebih besar atau sama dengan 300';a3[0] = [];a3[0][0] = '4 buah cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14';
a1[1] = 35;a2[1] = 'GT 35 sampai dengan kurang dari 300';a3[1] = [];a3[1][0] = '2 buah cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14';
a1[2] = 0;a2[2] = 'GT kurang dari 35';a3[2] = [];a3[2][0] = '2 buah cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 7;item[nomorItem] = 'h. Two way radio telephony';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Lsa1D - Pasal 82</i></div>"+teks;
