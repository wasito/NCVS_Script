...
nomorItem = 5;item[nomorItem] = 'f. Isyarat marabahaya (pyrotechnic)';a1[0] = 175;a2[0] = 'GT lebih besar atau sama dengan 175';a3[0] = [];a3[0][0] = '4 buah cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14';
a1[1] = 0;a2[1] = 'GT kurang dari 175';a3[1] = [];a3[1][0] = '2 (empat) unit cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 14;';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 7;item[nomorItem] = 'h. Two way radio telephony';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Lsa1E  - Pasal 83</i></div>"+teks;
