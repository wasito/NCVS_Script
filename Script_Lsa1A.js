...
a3[5][1]=[];a3[5][1][0] = 'Pelampung penolong yang memenuhi persyaratan dokumen Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 9 klausul 9.1.';
a3[5][1][1] = 'Dilengkapi dengan lampu yang dapat menyala sendiri dan 2 unit lainnya dilengkapi dengan tali apung.';
a1[6] = 0;a2[6] = 'Kurang dari 15 meter';a3[6] = [];a3[6][0] = 'Di lengkapi penampung penolong sebanyak 4 unit, terdiri dari:';
a3[6][1]=[];a3[6][1][0] = 'Pelampung penolong yang memenuhi persyaratan dokumen Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 9 klausul 9.1';
a3[6][1][1] = 'Dilengkapi dengan lampu yang dapat menyala sendiri dan 2 unit lainnya dilengkapi dengan tali apung.';i = -1; do { i++;} while (lKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[2] = 175;a2[2] = 'GT 175 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = 'Sarana pelontar tali yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 16. dengan 2 unit proyektil dan tali; 2 unit pistol pelontar roket dengan tali.';
...
nomorItem = 5;item[nomorItem] = 'f. Isyarat marabahaya (pyrotechnic)';a1[0] = 300;a2[0] = 'GT lebih besar atau sama dengan 300';a3[0] = [];a3[0][0] = '12 (dua belas) unit roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13;';
...
a1[1] = 35;a2[1] = 'GT lebih besar atau sama dengan 35 sampai dengan GT kurang dari 300';a3[1] = [];a3[1][0] = '12 (dua belas) unit roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13;';
a3[1][1] = '4 (empat) unit cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 14; dan';
a3[1][2] = '2 (dua) unit tabung asap oranye yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 2 klausul 15;';
a1[2] = 0;a2[2] = 'GT kurang dari 35';a3[2] = [];a3[2][0] = '12 (dua belas) unit roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Bab IV Seksi 13;';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		//if (arRad==1){teks="<p>A1</p>" +teks}
		//else if (arRad==2){teks="<p>A1+A2</p>" +teks} 
		//else if (arRad==3){teks="<p>A1+A2+A3</p>" +teks} 


		teks="<div style='font-size:10px'><i>Lsa1A - Pasal 79</i></div>"+teks;
