...
nomorItem = 1;item[nomorItem] = 'b. Pedoman gasing';a1[0] = 500;a2[0] = 'GT lebih besar atau sama dengan 500';a3[0] = [];a3[0][0] = 'Wajib dilengkapi dengan 1 (satu) unit yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 5 klausul 5.8';
...
nomorItem = 2;item[nomorItem] = 'c. Sistem kendali haluan atau lintasan (Heading or track control system (auto pilot))';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 3;item[nomorItem] = 'd. Pelorus atau alat baring pedoman (Pelorus or Compass Bearing Device)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Wajib dilengkapi, minimum dengan alat baring sederhana (perangkat jarum semat)';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 4;item[nomorItem] = 'e. Alat koreksi haluan dan baringan (Daftar deviasi)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Wajib dilengkapi. Catatan : Semua kompas magnet sebelum digunakan dan yang baru selesai melaksanakan pengeringan (dry docking) wajib di timbal.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 5;item[nomorItem] = 'f. Alat pancar petunjuk haluan (Transmitting Heading Device)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
nomorItem = 8;item[nomorItem] = 'i. Alat penerima sistem satelit navigasi (GPS)';a1[0] = 7;a2[0] = 'GT lebih besar dan sama dengan 7';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
a1[1] = 0;a2[1] = 'GT kurang dari 7';a3[1] = [];a3[1][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 9;item[nomorItem] = 'j. Radar 9 GHz (Pertama)';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi radar 9 GHz yang minimal memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 5 klausul 5.9.1';
...
nomorItem = 11;item[nomorItem] = 'l. Alat bantu ploting radar otomatis (ARPA)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 12;item[nomorItem] = 'm. Alat bantu garis haluan otomatis (Automatic tracking aid)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 13;item[nomorItem] = 'n. Alat bantu ploting elektronik';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 14;item[nomorItem] = 'o. Sistem identifikasi otomatis (AIS)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 15;item[nomorItem] = 'p. Perekam data pelayaran (VDR)';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 16;item[nomorItem] = 'q. Alat ukur kecepatan';a1[0] = 7;a2[0] = 'GT lebih besar dan sama dengan 7';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
a1[1] = 0;a2[1] = 'GT kurang dari 7';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 17;item[nomorItem] = 'r. Perum gema (echo sounding device)';a1[0] = 300;a2[0] = 'GT lebih besar dan sama dengan 300';a3[0] = [];a3[0][0] = 'Wajib dilengkapi perum gema yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 17 klausul 17.5';
...
nomorItem = 18;item[nomorItem] = 's. Indikator sudut daun kemudi, putaran baling-baling, kisar dan mode operasi baling – baling, arah daya dorong.';a1[0] = 0;a2[0] = 'Semua ukuran';a3[0] = [];a3[0][0] = 'Tidak diwajibkan, catatan:';
...
nomorItem = 22;item[nomorItem] = 'w. Reflektor radar';a1[0] = 35;a2[0] = 'GT lebih besar dan sama dengan 35';a3[0] = [];a3[0][0] = 'Wajib dilengkapi';
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Navigasi1C</i></div>"+teks;
