...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = 'Sarana pelontar tali yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi16. dengan 4 unit proyektil dan tali;';
a1[2] = 175;a2[2] = 'GT 175 sampai dengan kurang dari 300';a3[2] = [];a3[2][0] = 'Sarana pelontar tali yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi16. dengan 2 unit proyektil dan tali;';
a1[3] = 0;a2[3] = 'GT kurang dari 175';a3[3] = [];a3[3][0] = 'Tali buangan dengan panjang 30m sejumlah 4 unit.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 300;a2[1] = 'GT 300 sampai dengan kurang dari 500';a3[1] = [];a3[1][0] = '6 buah roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13;';
...
a3[2][1] = '4 buah cerawat tangan merah yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi; dan';
...
a1[3] = 0;a2[3] = 'GT kurang dari 175';a3[3] = [];a3[3][0] = '2 buah roket parasut isyarat marabahaya yang memenuhi persyaratan Standar Kapal Non Konvensi Berbendera Indonesia Bab IV Seksi 13.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[2] = 0;a2[2] = 'GT kurang dari 300';a3[2] = [];a3[2][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Lsa2C</i></div>"+teks;
