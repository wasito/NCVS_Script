...
a3[0][1] = 'Ruang permesinan wajib dilengkapi minimum 1 (satu) buah, dilengkapi dengan nosel tipe dual purpose (pancar dan semprot).';
...
a1[1] = 0;a2[1] = 'Kurang dari 50 meter';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (lKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Pemadam2E - Pasal 58</i></div>"+teks;
