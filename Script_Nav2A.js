...
nomorItem = 5;item[nomorItem] = 'f. Alat pancar petunjuk haluan (Transmitting Heading Device)';a1[0] = 500;a2[0] = 'GT lebih besar dan sama dengan 500';a3[0] = [];a3[0][0] = 'Wajib dilengkapi. Catatan : untuk kapal yang melakukan pelayaran Internasional mengikuti aturan konvensi.';
a1[1] = 0;a2[1] = 'GT kurang dari 500';a3[1] = [];a3[1][0] = 'Tidak diwajibkan.';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 0;a2[1] = 'GT kurang dari 0';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];

nomorItem = 17;item[nomorItem] = 'r. Perum gema (echo sounding device)';a1[0] = 300;a2[0] = 'GT lebih besar dan sama dengan 300';a3[0] = [];a3[0][0] = 'Wajib dilengkapi dengan perangkat elektronik perum gema Standar Kapal Non Konvensi Berbendera Indonesia Bab III Seksi 17 klausul 17.5. Catatan : untuk kapal yang melakukan pelayaran Internasional mengikuti aturan konvensi.';
...
a1[1] = 0;a2[1] = 'GT kurang dari 300';a3[1] = [];a3[1][0] = 'Radio handy talkie';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Navigasi2A</i></div>"+teks;
