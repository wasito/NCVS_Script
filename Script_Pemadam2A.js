...
a3[0][2]=[];a3[0][2][0] = 'GT sama dengan atau lebih besar dari 6.000 tekanan minimum = 0.31 N/mm2 ';
a3[0][2][1] = 'GT kurang dari 6.000 tekanan minimum = 0.25 N/mm2 ';
...
nomorItem = 11;item[nomorItem] = 'l. perangkat pemadam kebakaran api portabel.';a1[0] = 50;a2[0] = '50 meter atau lebih';a3[0] = [];a3[0][0] = '2 (dua) unit dry chemical masing - masing 4.5 kg di tiap geladak untuk ruang akomodasi dan ruang layanan setiap antara dinding kedap air dan dinding zona kebakaran.';
...
a1[1] = 25;a2[1] = 'Panjang 25 meter atau lebih dan kurang dari 50 meter';a3[1] = [];a3[1][0] = '1 (satu) unit dry chemicalkapasitas 4.5 kg untuk tiap ruang penumpang dan ruang ABK di tiap geladak.';
a3[1][1] = '1 (satu) unit dry chemical kapasitas4.5 kg di dapur';
...
a3[2][1] = '1 (satu) unit dry chemical kapasitas4,5 kg di dapur';
...
a1[1] = 25;a2[1] = '25 atau lebih dan kurang dari 50 meter';a3[1] = [];a3[1][0] = 'Wajib dilengkapi 1 (satu) set dan 1 (satu) tabung cadangan alat bantu pernapasan.';
...
nomorItem = 18;item[nomorItem] = 's. Bagan pengendali kebakaran (Fire control plan)';a1[0] = 175;a2[0] = 'GT sama dengan atau lebih besar 175';a3[0] = [];a3[0][0] = 'Bagan pengendali kebakaran yang telah dikukuhkan oleh pejabat yang berwenang wajib dipasang di dinding interior kapal yang mudah dilihat.';
...
a1[1] = 0;a2[1] = 'GT kurang dari 35';a3[1] = [];a3[1][0] = 'Tidak diwajibkan';i = -1; do { i++;} while (gtKu< a1[i]); batasan[nomorItem] = a2[i]; persyaratan[nomorItem] = a3[i];
		...
		teks="<div style='font-size:10px'><i>Pemadam2A - Pasal 54</i></div>"+teks;
